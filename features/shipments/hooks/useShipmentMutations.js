 ...
 * shipments at all — the mock server exposes just `GET /shipments` and
 * `GET /shipments/:id` (see `server/routes/shipments.js`) — so there is
 * nothing real to call here yet. This hook exists so the shape is ready for
