...
/**
 * PATCH by id — body `{product_inventory}`. Backs the restock modal's
 * "adjust an existing row" flow. No extra validation beyond `id` being
 * present (enforced by `inventorySchema` / the caller supplying it).
 */
